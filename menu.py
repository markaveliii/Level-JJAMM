...
class Menu:
    ...
    def display_menu(self, begin_x): # initially passed in stdscr
            # begin_x = 90;
            ...
            stdscr.refresh()
            for i in range(0, 20):
                    stdscr.addch(begin_y,begin_x+i, "#") 
                    stdscr.addch(begin_y+19,begin_x+i, "#") 
            for i in range(0, 20):
                    stdscr.addch(begin_y+i,begin_x, "#") 
                    stdscr.addch(begin_y+i,begin_x+19, "#") 
